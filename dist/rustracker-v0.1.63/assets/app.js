        ...
        function renderChart() {
            ...
            chart.setOption({
                ...
                grid: { left: 44, right: 40, top: 52, bottom: 36, containLabel: true },
                xAxis: {
                    type: "category",
                    boundaryGap: false,
                    data: labels,
        ...
        function closeSide() { side.classList.remove("open"); overlay.classList.remove("open"); hamburger.classList.remove("hidden"); }
        hamburger.addEventListener("click", () => { side.classList.toggle("open"); overlay.classList.toggle("open"); hamburger.classList.toggle("hidden"); });

...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Sora:wght@700&family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet">
    <style>
        :root {
            color-scheme: light;
            --ink: #1f2937;
    ...
    .metric.completed { border-top: 4px solid var(--violet); }
        ...
        .lang-icon { font-size: 20px; color: #9ca3af; flex-shrink: 0; }
        .lang-sel {
            width: 100%;
            background: #22304a;
            color: #f8fafc;
...
<body>
    <div class="app">
        <aside class="side">
            ...
            <div class="lang-bar">
                <span class="material-symbols-outlined lang-icon">translate</span>
